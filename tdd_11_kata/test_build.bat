...
set MAIN_OBJ=calc_test

if exist %MAIN_OBJ%.exe del %MAIN_OBJ%.exe

REM autogenerate cpp file for unit test:
call C:\cxxtest-4.3\cxxtestgen.py --error-print -o %MAIN_OBJ%.cpp %MAIN_OBJ%.h

REM compile resulted autogenerated cpp file to an exe-file:
call cl -EHsc -I"C:\cxxtest-4.3" -o %MAIN_OBJ%.exe %MAIN_OBJ%.cpp calc.cpp
