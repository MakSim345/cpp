...
static class TestDescription_ParserTestSuite_testPass8thExample : public CxxTest::RealTestDescription {
public:
 TestDescription_ParserTestSuite_testPass8thExample() : CxxTest::RealTestDescription( Tests_ParserTestSuite, suiteDescription_ParserTestSuite, 72, "testPass8thExample" ) {}
 void runTest() { suite_ParserTestSuite.testPass8thExample(); }
} testDescription_ParserTestSuite_testPass8thExample;

static class TestDescription_ParserTestSuite_testPass9thExample : public CxxTest::RealTestDescription {
public:
 TestDescription_ParserTestSuite_testPass9thExample() : CxxTest::RealTestDescription( Tests_ParserTestSuite, suiteDescription_ParserTestSuite, 79, "testPass9thExample" ) {}
 void runTest() { suite_ParserTestSuite.testPass9thExample(); }
} testDescription_ParserTestSuite_testPass9thExample;
