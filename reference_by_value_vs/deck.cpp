...
void deck::shuffle ()
{
    ...
    for (card_num = 1; card_num <=52; card_num++)
    {
        ...
        // printf ("KapTa HoMep %d: wDeck[%s][%s]\n", card_num, suit[row], face[column]);
